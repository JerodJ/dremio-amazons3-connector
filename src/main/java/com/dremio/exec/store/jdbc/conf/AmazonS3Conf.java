...
@SourceType(value = "AmazonS3ARP", label = "AmazonS3",uiConfig = "amazons3-layout.json")
public class AmazonS3Conf extends AbstractArpConf<AmazonS3Conf> {
  private static final String ARP_FILENAME = "arp/implementation/amazons3-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.amazons3.AmazonS3Driver";
